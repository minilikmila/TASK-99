 ...
 *
 * Verifies that the logger's maskFields format correctly redacts
 * sensitive fields (tokens, passwords, emails, IPs) before they
 * reach log output.
 */

export {};

// Replicate the masking logic from src/lib/logger.ts for unit testing
